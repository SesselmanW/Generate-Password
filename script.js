...
// If lower case OK is selected | Add the lowerCaseArray to combinedChoice array.
    if (lowerCaseChoice === "Y") {
        combinedChoice = combinedChoice.concat(lowerCaseArray);
    }
// If upper case OK is selected | Add the uppCaseArray to combinedChoice array.
    if (upperCaseChoice === "Y") {
        combinedChoice = combinedChoice.concat(upperCaseArray);
    }
// If number OK is selected | Add the numberArray to combinedChoice array.
    if (numberChoice === "Y") {
        combinedChoice = combinedChoice.concat(numberArray);
    }
// If special character OK is selected | Add the specialArray to combinedChoice array.
    if (specialChoice === "Y") {
        combinedChoice = combinedChoice.concat(specialArray)
    }
